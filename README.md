...
![image](https://i.imgur.com/1YycSdm.jpg)

[![Discord](https://img.shields.io/discord/527428494154792960?label=Discord%20-%20Zent%20Cash%20[ZTC])](https://discord.gg/tfaUE2G) 
[![GitHub issues](https://img.shields.io/github/issues/ZentCashFoundation/zentcashminer?label=Issues)](https://github.com/ZentCashFoundation/zentcashminer/issues)
[![GitHub contributors](https://img.shields.io/github/contributors-anon/ZentCashFoundation/zentcashminer?label=Contributors)](https://github.com/ZentCashFoundation/zentcashminer/graphs/contributors) 
[![GitHub All Releases](https://img.shields.io/github/downloads/ZentCashFoundation/zentcashminer/total?label=Downloads)](http://latest.zent.cash) 
![Version](https://img.shields.io/github/v/release/ZentCashFoundation/zentcashminer)

A CPU and NVIDIA miner for Zent Cash / Chukwa / ChukwaV2.

## Download

[Go here to download the latest release.](https://github.com/ZentCashFoundation/zentcashminer/releases)

If you prefer to compile yourself, read on. This can result in increased hashrates in some cases.

## Setup / Usage

We suggest you follow the [guide here](https://docs.zent.cash/guides/mining/zentcashminer-guide) to setup your miner.

## Algorithms Supported
* Zent Cash (Chukwa) - choose `zentcash` or `chukwa`
* Chukwa - choose `chukwa`
* ChukwaV2 - choose `chukwa_v2`
...
* Use command line options. Use `zentcashminer --help` to list them all. It is not recommended to use command line options, as they are less configurable than the config. Only `--algorithm`, `--pool`, and `--username` are mandatory.

For example:
```
./zentcashminer --algorithm zentcash --pool pool.zent.cash:11153 --username Ze3iyuhaF8S3FxWgX3nqXodakwxqNzzgXgz4xGezWHPfRt3CsFDeV7EccVykYByuVeTnxTbwUh4CeBM21ftZKMn82QHzRSDe9
```
    ...
    "pools": [
        {
            ...
            "rigID": "",
            "ssl": false,
            "username": "Ze3iyuhaF8S3FxWgX3nqXodakwxqNzzgXgz4xGezWHPfRt3CsFDeV7EccVykYByuVeTnxTbwUh4CeBM21ftZKMn82QHzRSDe9"
        },
        {
            "agent": "",
            "algorithm": "zentcash",
...
- `git clone https://github.com/ZentCashDevelopers/zentcashminer`
- `cd zentcashminer`
- `git submodule update --init --recursive`
- `mkdir build`
- `cd build`
- `cmake -G "Visual Studio 16 2019" -A x64 ..`
- `MSBuild zentcashminer.sln /p:Configuration=Release /m`
...
```
cd && rm -Rf zentcashminer && apt-get update && pkg update -y && pkg install cmake clang git -y && git clone https://github.com/ZentCashDevelopers/zentcashminer && mkdir zentcashminer/build && cd zentcashminer/ && git submodule update --init --recursive && cd build/ && cmake -DENABLE_NVIDIA=OFF .. && make
```
